...
void WTAll::WTCPU2GPU() {
	...
	cudaMemcpy(deviceWTIndex, WTIndex, (maxWTLength) * sizeof(int), cudaMemcpyHostToDevice);
	cudaMemcpy(deviceWTValue, WTValue, (maxWTLength) * sizeof(int), cudaMemcpyHostToDevice);
...
void WTAll::WTGPU2CPU() {
	...
	cudaMemcpy(WTIndex, deviceWTIndex, (maxWTLength) * sizeof(int), cudaMemcpyDeviceToHost);
	cudaMemcpy(WTValue, deviceWTValue, (maxWTLength) * sizeof(int), cudaMemcpyDeviceToHost);
...
void WTAll::chunkWTCPU2GPU(int argChunkId) {
	...
	cudaMemcpy(deviceChunkWTIndex, WTChunkVec[chunkId].WTIndex, (WTLengthVec[chunkId]) * sizeof(int), cudaMemcpyHostToDevice);
	cudaMemcpy(deviceChunkWTValue, WTChunkVec[chunkId].WTValue, (WTLengthVec[chunkId]) * sizeof(int), cudaMemcpyHostToDevice);
...
void WTAll::chunkWTGPU2CPU(int argChunkId) {
	...
	cudaMemcpy(WTChunkVec[chunkId].WTIndex, deviceChunkWTIndex, (WTLengthVec[chunkId]) * sizeof(int), cudaMemcpyDeviceToHost);
	cudaMemcpy(WTChunkVec[chunkId].WTValue, deviceChunkWTValue, (WTLengthVec[chunkId]) * sizeof(int), cudaMemcpyDeviceToHost);
