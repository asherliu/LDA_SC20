...
public:
	...
	long long int*			deviceMaxSecTopic[numStreams];
	unsigned short int*		deviceTotalTokenCount [numStreams];
	...
	float*		deviceWordMaxProb[numStreams];
	float*		deviceWordSecondMaxProb[numStreams];
	float*		deviceWordThirdMaxProb[numStreams];
	float*		deviceQArray[numStreams];
