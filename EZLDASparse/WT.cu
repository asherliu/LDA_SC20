...
//	memset(NZWTCount, 0, wordLength * sizeof(int));
...
void WTAll::GPUMemAllocate() {
	...
	cudaMalloc((void**)&deviceNZWTCount, (wordLength) * sizeof(int));
...
//	cudaMalloc((void**)&deviceNZWTCountCopy, wordLength * sizeof(int));
//	cudaMalloc((void**)&deviceWTIndexCopy, (maxWTLength) * sizeof(unsigned short int));
//	cudaMalloc((void**)&deviceWTValueCopy, (maxWTLength) * sizeof(unsigned short int));
...
{
//	cudaMemcpyAsync(deviceNZWTCount, deviceNZWTCountCopy, (wordLength) * sizeof(int), cudaMemcpyDeviceToDevice, stream);
//	cudaMemcpyAsync(deviceWTIndex, deviceWTIndexCopy, (maxWTLength) * sizeof(unsigned short int), cudaMemcpyDeviceToDevice, stream);
//	cudaMemcpyAsync(deviceWTValue, deviceWTValueCopy, (maxWTLength) * sizeof(unsigned short int), cudaMemcpyDeviceToDevice, stream);
//
//	cudaMemsetAsync(deviceNZWTCountCopy, 0, (wordLength) * sizeof(int), stream);
//	cudaMemsetAsync(deviceWTIndexCopy, 0, (maxWTLength) * sizeof(unsigned short int), stream);
//	cudaMemsetAsync(deviceWTValueCopy, 0, (maxWTLength) * sizeof(unsigned short int), stream);
//	cudaMemsetAsync(deviceWTRowSum, 0, (K) * sizeof(int), stream);

	cudaMemsetAsync(deviceNZWTCount, 0, (wordLength) * sizeof(int), stream);
